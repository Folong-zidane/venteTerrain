  ...
  useEffect(() => {
    const getProducts = async () => {
      ...
      if (componentMounted) {
        ...
        setData(products);
        setFilter(products.filter(product => product.category === "real estate"));
        setLoading(false);
      }
    ...
    return (
      <>
        <div className="buttons text-center py-5">
          ...
          <button className="btn btn-outline-dark btn-sm m-2" onClick={() => filterProduct("men's clothing")}>Colocation</button>
          <button className="btn btn-outline-dark btn-sm m-2" onClick={() => filterProduct("women's clothing")}>Chambre</button>
          <button className="btn btn-outline-dark btn-sm m-2" onClick={() => filterProduct("jewelery")}>Maison</button>
          <button className="btn btn-outline-dark btn-sm m-2" onClick={() => filterProduct("real estate")}>Real Estate</button>
        </div>
