    ...
    const imageData = [
        {
            ...
            ownerImage: 'https://images.pexels.com/photos/5411784/pexels-photo-5411784.jpeg?cs=srgb&dl=pexels-andrea-davis-5411784.jpg&fm=jpg', // URL de l'image du propriétaire
            ownerName: 'John le beau', // Nom du propriétaire
        },
        {
            alt: 'image2',
        ...
        // Ajoutez les données pour les autres images ici
    ];
    ...
    const renderSlides = imageData.map((image, index) => (
        <div key={index}>
            <div style={{ position: 'relative' }}>
                ...
                <Avatar src={image.ownerImage} alt={`Owner - ${image.ownerName}`} style={{ position: 'absolute', bottom: 0, right: 0 }} />
            </div>
        </div>
    ));
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Paragraph
                    text={'We have more 5000 reviews and our customers trust on our quality product and trust own our product. If you interested, contact us.'} 
                    maxWidth = {'sm'}
                    mx={'auto'}
                    textAlign={'center'}
                />
